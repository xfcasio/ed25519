...
pub struct U256FFE<const P: u128>(pub U256);
    
impl<const P: u128> FiniteField for U256FFE<P> {
...
impl<const P: u128> BitAnd<U256FFE<P>> for U256FFE<P> {
    type Output = U256FFE<P>;
...
impl<const P: u128> BitAnd<u32> for U256FFE<P> {
    type Output = U256FFE<P>;
...
impl<const P: u128> ShlAssign<i32> for U256FFE<P> {
    fn shl_assign(&mut self, other: i32) {
        self.0 <<= other;
    }
}
    
impl<const P: u128> Rem<U256FFE<P>> for U256FFE<P> {
    type Output = U256FFE<P>;
...
impl<const P: u128> Into<U256FFE<P>> for i32 {
